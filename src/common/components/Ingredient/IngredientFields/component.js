      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={4} md={5} lg={5} xl={5}>
          <SelectField
            ...
            label={t('recipe.page.form.label.field.ingredient')}
        ...
        <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
          <SelectField
            ...
            label={t('recipe.page.form.label.field.quantityType')}
            items={get(items, 'quantityTypes', [])}
          />
        </Grid>
        <Grid item xs={10} sm={3} md={2} lg={2} xl={2} className={classes.quantity}>
          <TextField name={`${name}.quantityValue`} type="number" margin="normal" label={t('recipe.page.form.label.field.quantity')} />
        </Grid>
        <Grid item xs={2} sm={1} md={1} lg={1} xl={1} className={classes.iconButton}>
          {displayButton && (
            <IconButton onClick={onClick} size="small" title={t('recipe.page.form.label.button.removeIngredient')}>
